...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvusername.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(Home.this, tvusername);
        ...
        if (imageUri != null) {
            ...
            avatarRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            db.collection("users").document(user.getUid()).update("avatarUrl", uri.toString())
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(Home.this, "Avatar updated successfully", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    });
                ...
                public void onFailure(@androidx.annotation.NonNull Exception e) {
                    Toast.makeText(Home.this, "Failed to upload avatar", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        db.collection("users").document(user.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (avatarUrl != null) {
                        Glide.with(Home.this).load(avatarUrl).into(imgAvatar);
                    } else {
