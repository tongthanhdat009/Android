...
//                    db.collection("users").document(user.getUid()).update("avatarUrl", downloadUri.toString())
//                            .addOnSuccessListener(new OnSuccessListener<Void>() {
//                                @Override
//                                public void onSuccess(Void unused) {
//                                    Toast.makeText(register_avatar.this, "Avatar đã lưu thành công", Toast.LENGTH_SHORT).show();
//                                    Intent intent = new Intent(register_avatar.this, Profile.class);
...
//        String defaultAvatarUrl = "gs://instagram-e3fd2.appspot.com/avatars/images.png";  // Điền URL của avatar mặc định từ Firebase
//        db.collection("users").document(user.getUid()).update("avatarUrl", defaultAvatarUrl)
//                .addOnSuccessListener(aVoid -> {
//                    Toast.makeText(this, "Đã lưu avatar mặc định", Toast.LENGTH_SHORT).show();
//                    Intent intent = new Intent(register_avatar.this, homeFragment.class);
//                    startActivity(intent);
//                    finish();
//                })
//                .addOnFailureListener(e ->
